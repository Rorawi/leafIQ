		...
		<div>
			<div className="space-y-4">
				<div className="flex justify-center bg-gray-100 py-2 px-8 rounded-md space-x-4 w-fit mx-auto">
					<button
						className={`px-4 py-2 bg-transparent text-black rounded cursor-pointer ${activeTab==="upload" ? "bg-green-500" : ""}`}
						onClick={() => setActiveTab("upload")}
					>
						Upload Image
					</button>
					<button
						className={`px-4 py-2 bg-transparent text-black rounded cursor-pointer ${activeTab==="live" ? "bg-green-500" : ""}`}
				...
				<div className="">
					{activeTab === "upload" && (
						<div className="mt-4 w-full h-full lg:max-h-96 flex justify-center items-center">
							<label
								htmlFor="file-upload"
								className="border-2 border-dashed border-green-400 rounded-md p-6 text-center hover:bg-green-50 transition h-full block cursor-pointer w-full"
							>
